                    ...
                    <!-- Here starts Submenu -->
					 ...
					 ?>
                      	<li>
                      		...
                      		<a href="<?php if($key == "lumiseproducts"){ echo $siteurl.'customize/admin.php?lumise-page=product'; }else{ echo 'index.php?option=com_j2store&view='.strtolower($key); } ?>"  tabindex="-1" target="<?php if($key == "lumiseproducts"){ echo '_blank'; } ?>" >
