...
<table class="table table-striped table-bordered">
	...
	<tbody>
			...
			<td><?php echo $checked; ?>
						...
						<?php if($item->lumiseid):?>
						
							<?php// echo $item->lumiseid;?>
							<a href="<?php echo JUri::root() ?>customize/admin.php?lumise-page=product&id=<?php echo $item->lumiseid;?>" target="_blank"><label class="label label-info">Edit Product Base</label></a>
							
							<?php else: ?>
							
							<a href="<?php echo JUri::root() ?>customize/admin.php?lumise-page=product" target="_blank"><label class="label label-success">Add Product Base</label></a>
