                        ...
                        <div class="span2">
                            <div class="j2store-product-general">
                                ...
                                <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    <?php echo J2Html::label(JText::_('Lumise Product id'), 'lumiseid',array('class'=>'control-label')); ?>
                                    <?php echo J2Html::text($prefix.'[lumiseid]', $this->variant->lumiseid,array('class'=>'input-small','id'=>'lumiseid_'.$this->variant->j2store_variant_id)); ?>
                                </div>
                            </div>
                            <div class="control-group">
