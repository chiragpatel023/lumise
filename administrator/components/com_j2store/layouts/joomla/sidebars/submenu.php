					...
					id="dropdown-<?php echo str_replace(" ", "-", $value['name']);?>">
							...
							<?php endif;?>
								<li class="<?php echo $class?>"><a
										href="<?php if($key == "lumiseproducts"){ echo $this->siteurl.'customize/admin.php?lumise-page=products'; }else{ echo $link_url; }?>" target="<?php if($key == "lumiseproducts"){ echo '_blank'; } ?>">
