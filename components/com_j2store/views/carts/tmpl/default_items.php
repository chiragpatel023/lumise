...
<th><?php echo JText::_('J2STORE_CART_LINE_ITEM'); ?></th>
			...
			<tbody>
				...
				<?php
					...
					if($item->cartitem->front_image != ''){
						$thumb_image = $item->cartitem->front_image;
					}else{
...
//echo '<pre>'; print_r($item->cartitem->front_image); exit;
				?>
				<tr>
					<td>
						...
						<?php if($this->params->get('show_thumb_cart', 1) && !empty($thumb_image)): ?>
							<span class="cart-thumb-image">
								...
								<?php if($item->cartitem->back_image){ ?>
									<img alt="<?php echo $item->orderitem_name; ?>" src="<?php echo $item->cartitem->back_image; ?>" >
								<?php } ?>
							</span>
						<?php endif; ?>
