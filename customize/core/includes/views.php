...
class lumise_views extends lumise_lib {
	...
	<ul data-block="right">
		...
		<li data-tool="cart" id="lumise-cart-options">
			<?php /*<button id="lumise-addToCart" title="<?php echo $this->main->lang('My cart'); ?>">
		...
		<li id="lumise-proceed">
			<button id="lumise-cart-action" class="lumise-btn-primary" data-add="<?php //echo $this->main->lang('Add to cart'); ?>Save & Checkout" data-update="<?php echo $this->main->lang('Update cart'); ?>" data-action="update-cart">
				<span><?php //echo $this->main->lang('Add to cart'); ?>Save & Checkout</span> 
				<i class="lumisex-android-arrow-forward"></i>
			</button>
		</li>
<form action="/demo/lumise/index.php/component/j2store/carts/addItem?Itemid=101" method="post" class="j2store-addtocart-form" id="j2store-addtocart-form-2" name="j2store-addtocart-form-2" data-product_id="2" data-product_type="simple" enctype="multipart/form-data" style="display:none">

		<div id="add-to-cart-2" class="j2store-add-to-cart">
		
		<div class="product-qty"><input type="number" name="product_qty" value="1" class="input-mini form-control " min="0" step="1"></div>
			<input type="hidden" id="j2store_product_id" name="product_id" value="<?php echo $_GET['id']; ?>">
...
<input type="hidden" name="front" value="" class="front-image">
<input type="hidden" name="back" value="" class="back-image">
