...
class lumise_connector {
    ...
    public function __construct() {
        ...
        $this->config = array(
            ...
            "upload_path" => '/home/u686862573/public_html/demo/lumise/customize/data/',
			"upload_url" => 'http://takshawebsoft.com/demo/lumise/customize/data/',
            "admin_assets_url" => $url.'core/admin/assets/',
            "admin_url" => $url.'admin.php?',
            
			"database" => array(
                "host" => 'localhost',
                "user" => 'u686862573_lumis',
                "pass" => 'nuVKULXDr7Dr',
                "name" => 'u686862573_lumis',
                "prefix" => 'lumise_'
            )
		);
	...
	public function update() {
		...
		if (!empty($connector_content)) {
			...
			$connector_content = str_replace(array(
				'/home/u686862573/public_html/demo/lumise/customize/data/',
				'http://takshawebsoft.com/demo/lumise/customize/data/',
				'localhost',
                'u686862573_lumis',
                'nuVKULXDr7Dr',
                'u686862573_lumis',
